    ...
    - Generate component : ng generate component rooms
    ...
    - To add bootstrap, npm install bootstrap, après l'ajouter dans angular.json

    - lifecycle hooks is used to hook into different EVENT on Components
      - ngOnInit() is called after the component is initialised and if we want to add some code
